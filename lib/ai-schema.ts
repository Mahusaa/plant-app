...
export const IdentifySchema = z.object({
  ...
  speciesName: z
    .string()
    .describe("Full scientific name (e.g., Monstera deliciosa)"),
  commonName: z
    .string()
    .describe("Primary common name (e.g., Swiss Cheese Plant)"),
  confidence: z
    .number()
    .min(0)
    .max(1)
  ...
  plantType: z
    ...
    .optional()
    .describe("Indoor or outdoor plant"),
  ...
  lightRequirements: z
    .object({
      ...
      description: z
        .string()
        .optional()
        .describe("Light description (e.g., Bright indirect light)"),
    })
    .describe("Light intensity thresholds for monitoring"),

  // Soil moisture requirements
  soilMoistureRequirements: z
    .object({
  ...
  wateringSchedule: z
    .object({
      amountMl: z
        .number()
        .describe("Water amount per session in ml (e.g., 500)"),
      frequencyDays: z
        .number()
        .describe("Watering frequency in days (e.g., 7)"),
  ...
  temperatureRange: z
    ...
    .optional()
    .describe("Temperature preferences"),
  ...
  humidityRange: z
    ...
    .optional()
    .describe("Humidity preferences"),

  // Care tips and notes
  careNotes: z
    .array(z.string())
    .describe("General care tips (max 2 most important tips tips)"),
  healthIssues: z
    .array(z.string())
    .optional()
    .describe("Common health issues to watch for max 2"),

  // Growing information
  growthRate: z
    .enum(["slow", "moderate", "fast"])
    .optional()
    .describe("Plant growth rate"),
  maxHeight: z
    .string()
    .optional()
    .describe("Maximum height (e.g., 2-3 meters)"),
  ...
  toxicity: z
    ...
    .optional()
    .describe("Toxicity information for pets/humans"),
});
